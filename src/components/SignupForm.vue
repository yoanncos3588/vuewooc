...
const firstNameBillValid = computed(() => validate(billingData.firstName, [isRequired, minMaxLength({ min: 1, max: 40 })]));
const lastNameBillValid = computed(() => validate(billingData.lastName, [isRequired, minMaxLength({ min: 1, max: 40 })]));
const companyBillValid = computed(() => validate(billingData.company, [isRequired, minMaxLength({ min: 1, max: 40 })]));
const address1BillValid = computed(() => validate(billingData.address1, [isRequired, minMaxLength({ min: 1, max: 40 })]));
const cityBillValid = computed(() => validate(billingData.city, [isRequired, minMaxLength({ min: 1, max: 40 })]));
const stateBillValid = computed(() => validate(billingData.state, [isRequired, minMaxLength({ min: 1, max: 40 })]));
const postcodeBillValid = computed(() => validate(billingData.postcode, [isRequired, minMaxLength({ min: 5, max: 5 })]));
const countryBillValid = computed(() => validate(billingData.country, [isRequired]));
const emailBillValid = computed(() => validate(billingData.email, [isRequired, isEmailValid, minMaxLength({ min: 1, max: 40 })]));
const phoneBillValid = computed(() => validate(billingData.phone, [isRequired, minMaxLength({ min: 1, max: 25 })]));
